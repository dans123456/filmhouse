...
function titlesMatch(titleA, titleB) {
    ...
    // 3. Token overlap comparison - require high similarity across both titles (>= 80% or 100% token coverage)
    ...
    if (postChannelBtn) {
        postChannelBtn.addEventListener("click", async () => {
            ...
            try {
                ...
                const token = telegramBotToken || localStorage.getItem("filmhouse_telegram_bot_token") || "8777518927:AAHl73JHfOXQrDGk-DR92XWoVkBMpMKXvYQ";
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (btnStartBroadcast) {
        btnStartBroadcast.addEventListener("click", async () => {
            ...
            if (!telegramBotToken) {
                telegramBotToken = localStorage.getItem("filmhouse_telegram_bot_token") || "8777518927:AAHl73JHfOXQrDGk-DR92XWoVkBMpMKXvYQ";
            }
            if (!telegramBotToken) {
